...
cat << EOF > online_processing.py	

from google.api_core.client_options import ClientOptions
from google.cloud import documentai_v1 as documentai


PROJECT_ID = "qwiklabs-gcp-04-d461fecfc0e7"
LOCATION = "us"  # Format is 'us' or 'eu'
PROCESSOR_ID = "787a13685491eb0d"  # Create processor in Cloud Console
...
# Format 'gs://output_bucket/directory'
GCS_OUTPUT_URI = "qwiklabs-gcp-04-d461fecfc0e7"
...
# Format 'gs://input_bucket/directory/file.pdf'
GCS_INPUT_URI = "gs://qwiklabs-gcp-04-d461fecfc0e7/Winnie_the_Pooh.pdf"
INPUT_MIME_TYPE = "application/pdf"

# Format 'gs://output_bucket/directory'
GCS_OUTPUT_URI = "gs://qwiklabs-gcp-04-d461fecfc0e7"
...
cat << EOF > batch_processing_directory.py	
...
GCS_INPUT_PREFIX = "gs://qwiklabs-gcp-04-d461fecfc0e7/multi-document"
